...
<div class="caja_popup2" id="formmodificar">
  <form method="POST" class="contenedor_popup" >
		...
		<tr><th colspan="2">Modificar usuario</th></tr>
            ...
            <tr> 
                <td>Direccion</td>
                <td><input type="text" name="txtdire" value="<?php echo $direccion;?>"required></td>
            </tr>
            <tr>
...
{    
    ...
    $direccion1 	= $_POST['txtdire']; 

      
    $querymodificar = mysqli_query($conn, "UPDATE usuarios SET nom='$nombre1',correo='$correo1',tel='$telefono1',direccion='$direccion1' WHERE cod=$codigo1");
